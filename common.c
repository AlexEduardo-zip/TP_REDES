                                 ...
                                 fd_set *conjunto_principal_ptr, int *fd_maximo_ptr)
{
    ...
    if ((socket_p2p_aceito = accept(socket_escuta_p2p, (struct sockaddr *)&endereco_peer, &tamanho_endereco)) == SOCKET_ERROR)
    {
    ...
    *socket_p2p_ptr = socket_p2p_aceito;
    FD_SET(*socket_p2p_ptr, conjunto_principal_ptr);
